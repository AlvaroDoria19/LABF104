...
| Dato | Valor |
|---|---|
| **ID de inventario** | `FW-SRX300-02` |
| **Modelo** | Juniper SRX300 |
| **Nº de serie** | ⚠️ Por confirmar |
| **Hostname actual** | `⚠️ Por confirmar` |
| **Hostname recomendado** | `F104-FW-SRX300-02` |
| **IP de gestión** | `192.168.104.52` |
...
> Credenciales **compartidas por toda la familia «Firewalls Juniper»** (`FW-SRX300-02/02`).
...
| Alta disponibilidad | ✅ **Chassis Cluster** de 2 nodos (con la pareja `FW-SRX300-02/02`) |
| PoE | ❌ No |
