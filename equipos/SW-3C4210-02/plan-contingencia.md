# 🚨 SW-3C4210-02 — Plan de contingencia
...
3. Con TFTP el menú pide: IP del switch (`192.168.104.14`), máscara (`255.255.255.0`),
...
tftp 192.168.104.10 put flash:/startup.cfg SW-3C4210-02_AAAA-MM-DD.cfg
```
...
binary
cd imagenes
put flash:/<imagen>.bin SW-3C4210-02_<imagen>.bin
bye
```
...
```text
tftp 192.168.104.10 get SW-3C4210-02_base.cfg flash:/startup.cfg
reboot
```
...
````markdown
### Intervención — SW-3C4210-02 — AAAA-MM-DD
