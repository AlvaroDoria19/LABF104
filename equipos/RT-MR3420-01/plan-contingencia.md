# 🚨 RT-MR3420-01 — Plan de contingencia
...
```text
scp lede-17.01.7-ar71xx-generic-tl-mr3420-v1-squashfs-sysupgrade.bin root@172.16.10.1:/tmp/
```
...
```text
scp root@172.16.10.1:/tmp/RT-MR3420-01_AAAA-MM-DD.tar.gz .
```
...
Guárdalo como `backups/configs/RT-MR3420-01_AAAA-MM-DD.txt`.

**Restaurar:**

```text
scp RT-MR3420-01_base.tar.gz root@172.16.10.1:/tmp/
```
