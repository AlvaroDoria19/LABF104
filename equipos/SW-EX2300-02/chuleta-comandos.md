# ⚡ SW-EX2300-02 — Chuleta de comandos
...
```text
configure
set system host-name F104-SW-EX2300-02
...
set interfaces irb unit 104 family inet address 192.168.104.32/24
...
```text
set interfaces me0 unit 0 family inet address 192.168.104.32/24
commit
```
