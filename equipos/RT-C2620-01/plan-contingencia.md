# 🚨 RT-C2620-01 — Plan de contingencia
...
|---|---|:--:|
| ☁️ **Google Drive del laboratorio** | [IMAGENES](https://drive.google.com/drive/folders/1XC3QRz-ewk9leXI7_Sp9qgzQ05ubQvwP?usp=drive_link) | ☐ |
...
```text
show running-config
copy running-config tftp://192.168.104.10/RT-C2620-01_AAAA-MM-DD.cfg
```
...
copy flash:c2600-is-mz.122-27.bin ftp://192.168.104.10/RT-C2620-01_c2600-is-mz.122-27.bin
```

Restaurar:

```text
copy tftp://192.168.104.10/RT-C2620-01_base.cfg startup-config
reload
```
