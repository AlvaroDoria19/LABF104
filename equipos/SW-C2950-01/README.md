# 🔵 SW-C2950-01 — Cisco Catalyst WS-C2950-24

> Switch de 24 puertos 10/100, Capa 2, con **Standard Image (SI)**. El mejor equipo del laboratorio para prácticas Cisco de VLAN, RSTP, EtherChannel y 802.1X.
...
| Dato | Valor |
|---|---|
| **ID de inventario** | `SW-C2950-01` |
| **Modelo** | Cisco Catalyst WS-C2950-24 |
| **Nº de serie** | FHK0621X02J |
| **Hostname actual** | `SW_SERVERS` |
| **Hostname recomendado** | `F104-SW-2950-01` |
| **IP de gestión** | `192.168.104.16` |
...
| Dato | Valor |
|---|---|
| Sistema operativo | **Cisco IOS 12.1(22)EA13**, RELEASE SOFTWARE (fc2) |
| Feature set | **Standard Image (SI)** (`C2950-I6Q4L2-M`) — ⚠️ sin criptografía |
| Imagen en flash | `c2950-i6q4l2-mz.121-22.EA13.bin` |
| ROM / Bootstrap | C2950 boot loader |
| Compilada | 27-Feb-2009 |
| Última rama publicada | `12.1(22)EA14` (estás una versión por detrás) |
...
| Dato | Valor |
|---|---|
| Modelo exacto | **WS-C2950-24** (revisión B0) |
| Processor board ID | `FHK0621X02J` |
| MAC base | `00:09:B7:C1:52:C0` |
| CPU | RC32300 |
| DRAM | **≈ 20 MB** (20 957 K) |
| Flash | ⚠️ Por confirmar con `dir flash:` (típicamente 8 MB en este modelo) |
| NVRAM | 32 KB simulada en flash |
| Puertos | **24 × 10/100** FastEthernet (sin uplinks Gigabit en este modelo) |
| Nº de placa base | 73-5781-10 |
