# ⭐ SW-PC7024-02 — Características y protocolos
...
- ⚠️ **Todas las unidades tienen el mismo `hostname` (`L3Switch`)**. Renómbralas siguiendo la convención del laboratorio (`F104-SW-PC7024-02`, `-02`…) o será imposible saber en cuál estás trabajando.
