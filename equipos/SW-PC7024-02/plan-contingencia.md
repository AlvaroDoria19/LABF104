# 🚨 SW-PC7024-02 — Plan de contingencia
...
```text
show running-config
copy running-config tftp://192.168.104.10/SW-PC7024-02_AAAA-MM-DD.cfg
```

También por FTP:

```text
copy running-config ftp://labftp:<clave>@192.168.104.10/imagenes/SW-PC7024-02_AAAA-MM-DD.cfg
```
...
```text
copy ?
copy image1 ftp://labftp:<clave>@192.168.104.10/imagenes/SW-PC7024-02_PC7024.stk
```

Restaurar configuración:

```text
copy tftp://192.168.104.10/SW-PC7024-02_base.cfg startup-config
reload
```
...
````markdown
### Intervención — SW-PC7024-02 — AAAA-MM-DD
