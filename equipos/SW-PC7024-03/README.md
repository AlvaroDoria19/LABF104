# 🟡 SW-PC7024-03 — Dell PowerConnect 7024
...
| Dato | Valor |
|---|---|
| **ID de inventario** | `SW-PC7024-03` |
| **Modelo** | Dell PowerConnect 7024 |
| **Nº de serie** | ⚠️ Por confirmar |
| **Hostname actual** | `L3Switch` |
| **Hostname recomendado** | `F104-SW-PC7024-03` |
| **IP de gestión** | `192.168.104.23` |
...
> Credenciales **compartidas por toda la familia «Switches Dell»** (`SW-PC7024-03…04`).
