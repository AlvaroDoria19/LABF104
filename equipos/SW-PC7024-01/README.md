# 🟡 SW-PC7024-01 — Dell PowerConnect 7024
...
| Dato | Valor |
|---|---|
| **ID de inventario** | `SW-PC7024-01` |
| **Modelo** | Dell PowerConnect 7024 |
| **Nº de serie** | ⚠️ Por confirmar |
| **Hostname actual** | `L3Switch` |
| **Hostname recomendado** | `F104-SW-PC7024-01` |
| **IP de gestión** | `192.168.104.21` |
...
> Credenciales **compartidas por toda la familia «Switches Dell»** (`SW-PC7024-01…04`).
