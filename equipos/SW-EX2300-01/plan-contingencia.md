# 🚨 SW-EX2300-01 — Plan de contingencia
...
Copia la salida a `backups/configs/SW-EX2300-01_AAAA-MM-DD.conf`.
...
```text
scp lab-admin@192.168.104.31:/config/juniper.conf.gz C:\LabF104\imagenes\SW-EX2300-01_juniper.conf.gz
```
...
cp /config/juniper.conf.gz /var/tmp/usb/SW-EX2300-01_juniper.conf.gz
ls -lh /var/tmp/usb
umount /var/tmp/usb
exit
```
